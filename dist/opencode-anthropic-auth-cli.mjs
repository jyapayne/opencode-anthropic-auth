...
var HEADER_PROFILES = {
  "claude-cli-default": CLAUDE_CLI_2_1_79_PROFILE,
...
var DEFAULT_HEADER_PROFILE = "claude-cli-2.1.79";
...
// lib/oauth.mjs
var CC_USER_AGENT = getHeaderProfile()?.headers?.["user-agent"] ?? "claude-cli/2.1.79 (external, cli)";
